...
class Ui_RIFEDialog(object):
    def setupUi(self, RIFEDialog):
        ...
        self.gridLayout_3.addWidget(self.PresetReminder, 0, 5, 1, 1)
        ...
        self.PresetSelector.addItem("")
        self.PresetSelector.addItem("")
        self.gridLayout_3.addWidget(self.PresetSelector, 0, 6, 1, 1)
        self.gridLayout_11.addLayout(self.gridLayout_3, 0, 0, 1, 1)
        self.gridLayout_4 = QtWidgets.QGridLayout()
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.Round = QtWidgets.QLineEdit(self.step2)
        self.Round.setObjectName("Round")
        self.gridLayout_4.addWidget(self.Round, 1, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.StartFrame, 1, 0, 1, 1)
        self.EndFrame = QtWidgets.QLineEdit(self.step2)
        self.EndFrame.setObjectName("EndFrame")
        self.gridLayout_4.addWidget(self.EndFrame, 1, 2, 1, 1)
        ...
        self.label_4 = QtWidgets.QLabel(self.step2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_5.addWidget(self.HwaccelChecker, 0, 3, 1, 1)
        ...
        RIFEDialog.setTabOrder(self.StartFrame, self.StartChunk)
        RIFEDialog.setTabOrder(self.StartChunk, self.EndFrame)
        RIFEDialog.setTabOrder(self.EndFrame, self.Round)
        RIFEDialog.setTabOrder(self.Round, self.UHDChecker)
        RIFEDialog.setTabOrder(self.UHDChecker, self.HwaccelChecker)
        RIFEDialog.setTabOrder(self.HwaccelChecker, self.PauseChecker)
        RIFEDialog.setTabOrder(self.PauseChecker, self.RIFEOnlyChecker)
        RIFEDialog.setTabOrder(self.RIFEOnlyChecker, self.RenderOnlyChecker)
    ...
    def retranslateUi(self, RIFEDialog):
        ...
        self.Round.setPlaceholderText(_translate("RIFEDialog", "循环次数(round)"))
        self.label_2.setText(_translate("RIFEDialog", "*起始块数："))
        self.StartFrame.setPlaceholderText(_translate("RIFEDialog", "起始帧数(startframe)"))
        self.EndFrame.setPlaceholderText(_translate("RIFEDialog", "结束帧数(endframe)"))
        self.StartChunk.setPlaceholderText(_translate("RIFEDialog", "起始块数(chunk)"))
        self.label_4.setText(_translate("RIFEDialog", "循环次数："))
        self.label.setText(_translate("RIFEDialog", "*(必填)起始帧数："))
        self.label_3.setText(_translate("RIFEDialog", "结束帧数："))
