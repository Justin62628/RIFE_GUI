...
class Ui_RIFEDialog(object):
    def setupUi(self, RIFEDialog):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.OneLineShotBrowser.sizePolicy().hasHeightForWidth())
        self.OneLineShotBrowser.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.FFmpegBrowser.sizePolicy().hasHeightForWidth())
        self.FFmpegBrowser.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.InputBrowser.sizePolicy().hasHeightForWidth())
        self.InputBrowser.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.RIFEBrowser.sizePolicy().hasHeightForWidth())
        self.RIFEBrowser.setSizePolicy(sizePolicy)
        ...
        self.InputFPS = QtWidgets.QLabel(self.step1)
        ...
        self.OneLineShotChecker = QtWidgets.QRadioButton(self.groupBox_5)
        ...
        self.gridLayout_11.addWidget(self.groupBox_5, 5, 0, 1, 1)
        ...
        self.UHDChecker = QtWidgets.QCheckBox(self.groupBox_4)
        ...
        self.gridLayout_11.addWidget(self.DebugChecker, 8, 0, 1, 1)
        ...
        self.PresetSelector.addItem("")
        self.PresetSelector.addItem("")
        self.gridLayout_3.addWidget(self.PresetSelector, 0, 12, 1, 1)
        self.CRFReminder = QtWidgets.QLabel(self.groupBox)
        ...
        self.gridLayout_3.addWidget(self.HwaccelChecker, 0, 13, 1, 1)
        self.TargetBitrateReminder = QtWidgets.QLabel(self.groupBox)
        ...
        self.gridLayout_3.addWidget(self.TargetBitrateReminder, 0, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.PresetReminder, 0, 11, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.line_2, 4, 0, 1, 1)
        ...
        self.gridLayout_15.addWidget(self.DupRmChecker, 0, 5, 1, 1)
        self.ScdetTSelector = QtWidgets.QDoubleSpinBox(self.groupBox_2)
        ...
        self.gridLayout_15.addWidget(self.label_4, 0, 6, 1, 1)
        self.ScedetTReminder = QtWidgets.QLabel(self.groupBox_2)
        self.ScedetTReminder.setObjectName("ScedetTReminder")
        self.gridLayout_15.addWidget(self.ScedetTReminder, 0, 2, 1, 1)
        self.ScdetTMark = QtWidgets.QLabel(self.groupBox_2)
        ...
        self.DupFramesTSelector = QtWidgets.QSpinBox(self.groupBox_2)
        self.DupFramesTSelector.setMinimum(1)
        self.DupFramesTSelector.setMaximum(8)
        self.DupFramesTSelector.setProperty("value", 8)
        self.DupFramesTSelector.setObjectName("DupFramesTSelector")
        self.gridLayout_15.addWidget(self.DupFramesTSelector, 0, 7, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.line, 6, 0, 1, 1)
        ...
        self.StartCntFrame = QtWidgets.QLineEdit(self.groupBox_3)
        ...
        self.gridLayout_7.addWidget(self.InterpScaleReminder, 0, 2, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.UseNCNNButton, 0, 5, 1, 1)
        ...
        self.InterpScaleSelector.addItem("")
        self.InterpScaleSelector.addItem("")
        self.gridLayout_7.addWidget(self.InterpScaleSelector, 0, 3, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.UseCUDAButton, 0, 4, 1, 1)
        self.gridLayout_22.addLayout(self.gridLayout_7, 0, 0, 1, 1)
        self.gridLayout_11.addWidget(self.groupBox_6, 7, 0, 1, 1)
        ...
        self.TerminateButton = QtWidgets.QPushButton(self.step3)
        self.TerminateButton.setObjectName("TerminateButton")
        self.gridLayout_8.addWidget(self.TerminateButton, 2, 1, 1, 1)
        self.ProcessStart = QtWidgets.QPushButton(self.step3)
        self.ProcessStart.setObjectName("ProcessStart")
        self.gridLayout_8.addWidget(self.ProcessStart, 2, 0, 1, 1)
        self.OptionCheck = QtWidgets.QTextEdit(self.step3)
        self.OptionCheck.setObjectName("OptionCheck")
        self.gridLayout_8.addWidget(self.OptionCheck, 0, 0, 2, 3)
        self.pushButton_2 = QtWidgets.QPushButton(self.step3)
        ...
        RIFEDialog.setTabOrder(self.UHDChecker, self.RenderOnlyChecker)
    ...
    def retranslateUi(self, RIFEDialog):
        ...
        self.RIFEPath.setPlaceholderText(_translate("RIFEDialog", "inference_img_only.exe/py路径"))
        self.RIFEBrowser.setText(_translate("RIFEDialog", "设置RIFE核心路径"))
        self.OneLineShotPath.setPlaceholderText(_translate("RIFEDialog", "one_line_shot_args.exe/py路径"))
        self.InputFPSReminder.setText(_translate("RIFEDialog", "输入视频帧率："))
        self.InputFPS.setText(_translate("RIFEDialog", "Unknown"))
        ...
        self.groupBox_5.setTitle(_translate("RIFEDialog", "补帧工作流设置"))
        self.OneLineShotChecker.setText(_translate("RIFEDialog", "一条龙模式"))
        self.PauseChecker.setToolTip(
            _translate("RIFEDialog", "<html><head/><body><p>转场识别完成后程序暂停，等待用户删除误被识别为转场的帧</p></body></html>"))
        ...
        self.QuickExtractChecker.setToolTip(
            _translate("RIFEDialog", "<html><head/><body><p>使用ffmpeg内置视频导出图片算法，速度稍快，但可能出现颜色偏差</p></body></html>"))
        ...
        self.groupBox_4.setTitle(_translate("RIFEDialog", "输出视频信息"))
        ...
        self.UHDChecker.setToolTip(
            _translate("RIFEDialog", "<html><head/><body><p>将最终压制模式切换到适合4K分辨率素材的情况</p></body></html>"))
        ...
        self.CropReminder.setToolTip(_translate("RIFEDialog",
                                                "<html><head/><body><p>对于一个分辨率为3840x2160的素材，假定它上下有276个像素的黑边，那么裁切参数应为3840:(3840-276*2):0:276=<span style=\" font-weight:600;\">3840:1608:0:276</span>，</p><p>其中处于第三个位置的0是竖直裁切方式，推导方式类似</p></body></html>"))
        self.CropReminder.setText(_translate("RIFEDialog", "   裁切参数(不裁切填0)"))
        self.DebugChecker.setText(_translate("RIFEDialog", "Debug"))
        self.groupBox.setTitle(_translate("RIFEDialog", "压制参数设置"))
        ...
        self.CRFReminder.setToolTip(_translate("RIFEDialog",
                                               "<html><head/><body><p><span style=\" font-weight:600;\">取值0~51</span></p><p>16肉眼分辨不出差距，能看</p><p>51最差</p><p><span style=\" font-weight:600;\">默认9</span></p></body></html>"))
        self.CRFReminder.setWhatsThis(_translate("RIFEDialog",
                                                 "<html><head/><body><p>0~51</p><p>16肉眼分辨不出差距，能看</p><p>51最差</p><p>默认9</p></body></html>"))
        self.CRFReminder.setText(_translate("RIFEDialog", "恒定质量控制参数(CRF)："))
        self.HwaccelChecker.setToolTip(
            _translate("RIFEDialog", "<html><head/><body><p>使用ffmpeg的hevc_nvenc或h264_nvenc编码器压制最终成品</p></body></html>"))
        self.HwaccelChecker.setText(_translate("RIFEDialog", "使用硬件编码"))
        self.TargetBitrateReminder.setToolTip(_translate("RIFEDialog",
                                                         "<html><head/><body><p>1080p蓝光50M</p><p>4K蓝光60~90M</p><p>线上4K：20M</p><p>B站发布：20~40M（<span style=\" font-weight:600;\">反正也会被二压</span>）</p></body></html>"))
        self.TargetBitrateReminder.setText(_translate("RIFEDialog", " 目标码率："))
        self.TargetBitrateMeasure.setText(_translate("RIFEDialog", "M "))
        self.PresetReminder.setToolTip(_translate("RIFEDialog",
                                                  "<html><head/><body><p>硬编：GPU压制，只有勾选硬件编码才能使用</p><p>软编：CPU压制，速度慢，但是质量可能比硬件编码好一丢丢（虽然大量的SSIM对比实验结果表面当今硬件编码质量与CPU编码不分伯仲）</p><p><br/></p><p><span style=\" font-weight:600;\">注意：软编可以直接压入HDR10数据，现阶段的硬编不行</span></p></body></html>"))
        self.PresetReminder.setText(_translate("RIFEDialog", "  选择压制预设："))
        self.groupBox_2.setTitle(_translate("RIFEDialog", "转场与重复帧识别参数设置"))
        self.DupRmChecker.setText(_translate("RIFEDialog", "智能重复帧优化"))
        self.label_4.setText(_translate("RIFEDialog", "    重复帧识别阈值："))
        self.ScedetTReminder.setToolTip(_translate("RIFEDialog",
                                                   "<html><head/><body><p>若两个识别出的、相邻的转场相距时间小于这个值，<span style=\" font-weight:600;\">前一个</span>转场会被舍弃</p></body></html>"))
        self.ScedetTReminder.setText(_translate("RIFEDialog", "     转场最低间隔"))
        self.ScdetTMark.setText(_translate("RIFEDialog", "s"))
        self.ScdetReminder.setToolTip(_translate("RIFEDialog",
                                                 "<html><head/><body><p><span style=\" font-weight:600;\">取值1~9</span></p><p>3D素材（有景深的画面）选2~3</p><p>2D素材（平面，如2D动画）选1~2</p></body></html>"))
        self.ScdetReminder.setText(_translate("RIFEDialog", "转场灵敏度："))
        self.groupBox_3.setTitle(_translate("RIFEDialog", "补帧启动前准备"))
        self.StartChunk.setPlaceholderText(_translate("RIFEDialog", "起始块数(chunk)"))
        self.AutoSetReminder.setToolTip(
            _translate("RIFEDialog", "<html><head/><body><p>根据已经生成的视频块信息进行推算，可能存在重复补帧的情况，但不影响最终结果</p></body></html>"))
        ...
        self.label_3.setToolTip(_translate("RIFEDialog",
                                           "<html><head/><body><p>假定程序补到原视频的256帧被终止，补帧倍率为x4，则会生成256 * 4 = <span style=\" font-weight:600;\">1024</span>张图片，那么这里要指定1025</p></body></html>"))
        ...
        self.label.setToolTip(
            _translate("RIFEDialog", "<html><head/><body><p>假如程序补到原视频的第256帧即被终止，那么这里应该指定257</p></body></html>"))
        ...
        self.groupBox_6.setTitle(_translate("RIFEDialog", "RIFE补帧设置"))
        self.InterpScaleReminder.setToolTip(_translate("RIFEDialog",
                                                       "<html><head/><body><p>对分辨率较小的素材进行补帧，这个值要拉大：<span style=\" font-weight:600;\">2.0~4.0</span></p><p>可减小对有大量花纹的画面补帧出现的坏帧情况</p><p>对4K视频补帧推荐取值<span style=\" font-weight:600;\">0.5</span></p></body></html>"))
        self.InterpScaleReminder.setText(_translate("RIFEDialog", "  补帧精度倍数  "))
        self.FP16Checker.setText(_translate("RIFEDialog", "半精度模式（fp16, 低显存）"))
        self.ReverseChecker.setToolTip(_translate("RIFEDialog",
                                                  "<html><head/><body><p>将前一张图片作为补帧的参考，即，<span style=\" font-weight:600;\">从后向前补</span>。</p><p>会比正向光流更流畅，但会严重影响3D动画补帧的高速运动的画面质量</p></body></html>"))
        self.ReverseChecker.setText(_translate("RIFEDialog", "反向光流"))
        self.UseNCNNButton.setText(_translate("RIFEDialog", "使用NCNN（A卡专用）"))
        ...
        self.UseCUDAButton.setText(_translate("RIFEDialog", "使用CUDA（N卡，无则CPU）"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.step2), _translate("RIFEDialog", "Step2：选择模式、功能"))
        self.TerminateButton.setText(_translate("RIFEDialog", "终止进程(useless)"))
        self.ProcessStart.setText(_translate("RIFEDialog", "一条龙开始"))
        self.pushButton_2.setText(_translate("RIFEDialog", "救救强迫症"))
