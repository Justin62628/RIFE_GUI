...
class Ui_RIFEDialog(object):
    def setupUi(self, RIFEDialog):
        ...
        self.InputFileName = MyTextWidget(self.step1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.HDRChecker = QtWidgets.QCheckBox(self.groupBox_4)
        self.HDRChecker.setObjectName("HDRChecker")
        self.gridLayout_5.addWidget(self.HDRChecker, 0, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.InterpScaleReminder, 1, 0, 1, 1)
        ...
        self.InterpScaleSelector.addItem("")
        self.InterpScaleSelector.addItem("")
        self.gridLayout_7.addWidget(self.InterpScaleSelector, 1, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.UseCPUButton, 0, 7, 1, 1)
        self.UseNCNNButton = QtWidgets.QRadioButton(self.groupBox_6)
        self.UseNCNNButton.setCheckable(False)
        self.UseNCNNButton.setChecked(False)
        self.UseNCNNButton.setObjectName("UseNCNNButton")
        self.gridLayout_7.addWidget(self.UseNCNNButton, 0, 6, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.UseMultiCUDAButton, 0, 5, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.ModuleSelector, 2, 1, 1, 1)
        self.label_6 = QtWidgets.QLabel(self.groupBox_6)
        self.label_6.setAlignment(QtCore.Qt.AlignCenter)
        self.label_6.setObjectName("label_6")
        self.gridLayout_7.addWidget(self.label_6, 1, 5, 1, 3)
        ...
        self.gridLayout_7.addWidget(self.DiscreteCardSelector, 2, 5, 1, 3)
        self.GPUInfoButton = QtWidgets.QPushButton(self.groupBox_6)
        self.GPUInfoButton.setObjectName("GPUInfoButton")
        self.gridLayout_7.addWidget(self.GPUInfoButton, 2, 4, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.ProcessStart, 2, 0, 1, 2)
        ...
        self.gridLayout_26.addWidget(self.ConcatButton, 1, 0, 1, 1)
        ...
        RIFEDialog.setTabOrder(self.InputFileName, self.OutputFolder)
        ...
        RIFEDialog.setTabOrder(self.StartCntFrame, self.HDRChecker)
        RIFEDialog.setTabOrder(self.HDRChecker, self.DebugChecker)
    ...
    def retranslateUi(self, RIFEDialog):
        ...
        self.OutputFolder.setPlaceholderText(_translate("RIFEDialog", "拖入补帧项目输出的文件夹路径（对于4K补帧，剩余空间建议20G+）"))
        self.InputFileName.setPlaceholderText(_translate("RIFEDialog", "拖入要补帧的视频文件(推荐.mp4, .mkv)"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.step1), _translate("RIFEDialog", " Step1：输入文件 "))
        self.groupBox_3.setTitle(_translate("RIFEDialog", "补帧状态恢复"))
        ...
        self.ResizeSettings.setPlaceholderText(_translate("RIFEDialog", "如320x180,高不能为单数"))
        ...
        self.CropReminder.setText(_translate("RIFEDialog", "    裁切参数    "))
        self.HDRChecker.setToolTip(_translate("RIFEDialog", "<html><head/><body><p>将最终压制模式切换到适合带有<span style=\" font-weight:600;\">HDR</span>内容素材的情况</p><p><br/></p></body></html>"))
        self.HDRChecker.setText(_translate("RIFEDialog", "HDR适配模式"))
        self.CropSettings.setToolTip(_translate("RIFEDialog", "<html><head/><body><p>ffmpeg的裁切参数，<span style=\" font-weight:600;\">裁切后的视频宽:裁切后的视频高:左右各裁切的像素数:上下各裁切的像素数</span>，支持ffmpeg自定义参数（iw，ih等）（代码注入的好机会噢~）</p></body></html>"))
        self.CropSettings.setPlaceholderText(_translate("RIFEDialog", "如3840:1608:0:276"))
        ...
        self.label_5.setText(_translate("RIFEDialog", "使用模型："))
        ...
        self.FP16Checker.setText(_translate("RIFEDialog", "半精度模式（占用显存小）"))
        ...
        self.UseCPUButton.setText(_translate("RIFEDialog", "使用CPU"))
        self.UseNCNNButton.setText(_translate("RIFEDialog", "使用A卡"))
        self.UseMultiCUDAButton.setText(_translate("RIFEDialog", "使用N卡多卡"))
        self.UseCUDAButton.setText(_translate("RIFEDialog", "使用N卡（无则CPU）"))
        self.label_6.setText(_translate("RIFEDialog", "调用的显卡："))
        self.GPUInfoButton.setToolTip(_translate("RIFEDialog", "<html><head/><body><p>同时获得显卡信息和模型存储情况</p><p>优先点击！</p><p>如遇到问题请联系开发者</p></body></html>"))
        self.GPUInfoButton.setText(_translate("RIFEDialog", "获取显卡信息"))
        self.groupBox_5.setTitle(_translate("RIFEDialog", "补帧工作流设置，可自由组合"))
        ...
        self.ImgOutputChecker.setText(_translate("RIFEDialog", "输出图片(不勾选则输出视频)"))
        ...
        self.NoConcatChecker.setText(_translate("RIFEDialog", "不进行合并（空间不够需手动合并）"))
        self.OutputOnlyChecker.setText(_translate("RIFEDialog", "仅保留输出（图片/视频）"))
        ...
        self.ProcessStart.setText(_translate("RIFEDialog", "按我开始！"))
