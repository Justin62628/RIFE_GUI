...
class RIFE_GUI_BACKEND(QDialog, RIFE_GUI.Ui_RIFEDialog):
    ...
    def load_current_settings(self):
        ...
        appData.setValue("quick_extract", True)
        ...
        appData.setValue("slow_motion", False)
