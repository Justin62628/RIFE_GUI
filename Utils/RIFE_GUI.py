...
class Ui_RIFEDialog(object):
    def setupUi(self, RIFEDialog):
        ...
        self.label_7 = QtWidgets.QLabel(self.step1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_3.addWidget(self.PresetReminder, 0, 10, 1, 1)
        ...
        self.PresetSelector.addItem("")
        self.PresetSelector.addItem("")
        self.gridLayout_3.addWidget(self.PresetSelector, 0, 11, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.EncoderReminder, 0, 12, 1, 1)
        ...
        self.EncoderSelector.addItem("")
        self.gridLayout_3.addWidget(self.EncoderSelector, 0, 13, 1, 1)
        self.HwaccelChecker = QtWidgets.QCheckBox(self.groupBox)
        self.HwaccelChecker.setObjectName("HwaccelChecker")
        self.gridLayout_3.addWidget(self.HwaccelChecker, 0, 14, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.CropReminder, 0, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.CropSettings, 0, 1, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.DiscreteCardSelector, 2, 4, 1, 4)
        self.label_6 = QtWidgets.QLabel(self.groupBox_6)
        self.label_6.setAlignment(QtCore.Qt.AlignCenter)
        self.label_6.setObjectName("label_6")
        self.gridLayout_7.addWidget(self.label_6, 1, 4, 1, 4)
        ...
        self.gridLayout_8.addWidget(self.ProcessStart, 3, 0, 1, 2)
    ...
    def retranslateUi(self, RIFEDialog):
        ...
        self.label_7.setText(_translate("RIFEDialog", "<html><head/><body><p>往下面的框框<span style=\" font-weight:600;\">一次性</span>拖入要补帧的视频文件(只建议<span style=\" font-weight:600;\">.mp4</span>文件作为输入)<span style=\" font-weight:600;\">路径不要出现中文或特殊符号</span>！！！！！！！！！！！</p><p><span style=\" font-weight:600; font-style:italic;\">不可分批拖入！！ 拖错请直接重来！！</span></p><p><span style=\" font-weight:600; font-style:italic;\">当前版本只支持英伟达N卡！！！！！！！！！！！！！！</span></p><p>对于每一批次的补帧，所有补帧设置相同。拖入相关文件后，<span style=\" font-weight:600;\">请点击任意条目以获得输入帧率，并确认输入帧率和输出帧率。</span>由于帧率设置导致导出有问题的本团队概不负责。</p><p>Step1填写完毕后，请<span style=\" font-weight:600;\">前往Step2</span>填写并确认相关参数，并最后前往Step3启动补帧操作</p><p>鼠标在每一选项上悬浮可获得相关帮助信息，第一次使用必看！</p><p>遇到CUDA Out of Memory错误，请尝试勾上FP16（低显存模式），如错误重复出现，请尝试在<span style=\" font-weight:600;\">Step2</span>输出视频分辨率处按照要求填写分辨率较小的值（如对1080p视频补帧，填960x720以降到720p输出）</p><p>批处理功能说明：不推荐进行批量的长片段补帧，在未获得专业指导前，批处理中的每个片段推荐时长在<span style=\" font-weight:600;\">20s</span>以内</p><p>使用本软件<span style=\" font-weight:600;\">对超过30分钟</span>的素材补帧时，强烈建议先行联系开发团队获得推荐补帧方案！！！</p><p>对于十分钟以上的补帧操作，未先行联系开发团队而发生由于程序错误导致前功尽弃（白补）的情况的，本团队概不负责</p></body></html>"))
        self.OutputFolder.setPlaceholderText(_translate("RIFEDialog", "拖入补帧项目输出的文件夹路径（对于4K补帧，剩余空间建议20G+）（拖入的是文件夹！！！！！！）批处理模式下，\"仅保留输出文件\"模式将被强制启用（会删除所有中间文件，且不支持\"输出图片序列功能\"）"))
        ...
        self.EncoderReminder.setText(_translate("RIFEDialog", "  选择编码： "))
        ...
        self.DupRmChecker.setText(_translate("RIFEDialog", "智能重复帧优化(CUDA，仅用于20s内的片段)"))
        ...
        self.CropSettings.setPlaceholderText(_translate("RIFEDialog", "如3840:1608:0:276,不裁不填！！！"))
        ...
        self.UseNCNNButton.setText(_translate("RIFEDialog", "使用A卡(X)"))
        ...
        self.QuickExtractChecker.setText(_translate("RIFEDialog", "快速拆帧（不开启则5倍慢且可能导致CUDA占用不满）"))
        ...
        self.NoConcatChecker.setText(_translate("RIFEDialog", "不进行合并（适用于磁盘空间不足的情况）"))
